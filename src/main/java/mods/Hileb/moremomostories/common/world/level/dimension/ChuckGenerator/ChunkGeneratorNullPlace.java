package mods.Hileb.moremomostories.common.world.level.dimension.ChuckGenerator;

import mods.Hileb.moremomostories.common.world.blocks.ModBlocks;
import mods.Hileb.moremomostories.common.init.ModBiomes;
import mods.Hileb.moremomostories.common.world.level.structure.IHilebStructure;
        ...
        structuresHileb.add(new IHilebStructure() {
            ...
            public boolean doStructure(int x, int z, ChunkPrimer primer) {
                ...
                if (random.nextInt(100)<=1){
                    //MoreMoMoSrories.LogWarning("a big Structure in %d  50 %d",x*16,z*16);
