...
public class EntityZFP extends EntityAnimal {
    ...
    public EntityZFP(World worldIn) {
        ...
        this.setHeldItem(EnumHand.MAIN_HAND,new ItemStack(mods.Hileb.moremomostories.common.world.item.ModItems.ITEM_DAO));
        this.setItemStackToSlot(EntityEquipmentSlot.HEAD,new ItemStack(mods.Hileb.moremomostories.common.world.item.ModItems.ITEM_ZFP_HEADSET));
    }
...
//        this.targetTasks.addTask(3, new EntityAINearestAttackableTarget(this, EntityIronGolem.class, true));
    ...
    public Item ElectricShakingItem(){
        return mods.Hileb.moremomostories.common.world.item.ModItems.ITEM_DO_FOREVER;
    }
    @SubscribeEvent
