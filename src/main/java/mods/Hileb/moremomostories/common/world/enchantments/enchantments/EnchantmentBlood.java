package mods.Hileb.moremomostories.common.world.enchantments.enchantments;

import mods.Hileb.moremomostories.common.world.enchantments.EnchantmentBase;
import mods.Hileb.moremomostories.common.world.item.interfaces.IColorEnchantment;
import net.minecraft.enchantment.EnumEnchantmentType;
import net.minecraft.item.ItemStack;

import static mods.Hileb.moremomostories.common.world.enchantments.ModEnchantmentInit.mainHand;
