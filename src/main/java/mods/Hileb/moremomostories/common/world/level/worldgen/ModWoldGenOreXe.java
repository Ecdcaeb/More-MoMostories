    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
        ...
        if (world.provider.getDimension()==0 &&random.nextInt(256)<4 && world.getBlockState(new BlockPos(x,i,z)).getBlock()== Blocks.STONE){
            switch (random.nextInt(2)){
                case 0:
                    world.setBlockState(new BlockPos(x,i,z), ModBlocks.BLOCK_ORE_XE_BLUE.getDefaultState(),3);
                    break;
                case 1:
                    world.setBlockState(new BlockPos(x,i,z), ModBlocks.BLOCK_ORE_XE_RED.getDefaultState(),3);
                    break;
                case 2:
                    world.setBlockState(new BlockPos(x,i,z), ModBlocks.BLOCK_ORE_XE_BLACK.getDefaultState(),3);
                    break;
