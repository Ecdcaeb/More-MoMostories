...
import mods.Hileb.moremomostories.common.world.item.books.ItemBookBuddhaGodPalm;
import mods.Hileb.moremomostories.common.world.item.food.ItemFoodBase;
import mods.Hileb.moremomostories.common.world.item.food.ItemFoodDuckKao;
import mods.Hileb.moremomostories.common.world.item.food.ItemFoodSyzg;
import mods.Hileb.moremomostories.common.world.item.myItems.armor.ItemHeadSet;
import mods.Hileb.moremomostories.common.world.item.myItems.armor.ItemQGX;
import mods.Hileb.moremomostories.common.world.item.myItems.armor.ItemShiningSilverBreastplate;
import mods.Hileb.moremomostories.common.world.item.myItems.armor.ItemVanChest;
import mods.Hileb.moremomostories.common.world.item.paper.ItemPaper1;
import mods.Hileb.moremomostories.common.world.item.paper.ItemScene1;
import mods.Hileb.moremomostories.common.world.item.weapon.ItemZ;
import mods.Hileb.moremomostories.common.world.item.myItems.*;
