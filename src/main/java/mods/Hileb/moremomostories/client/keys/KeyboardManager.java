package mods.Hileb.moremomostories.client.keys;

import mods.Hileb.moremomostories.MoreMoMoSrories;
import mods.Hileb.moremomostories.proxy.ClientProxy;
...
//            MoreMoMoSrories.Log("pressed key cast :" + hand);
//
//            ItemStack item = player.getHeldItem(hand);
//            if(item.isEmpty())
//            {
//                MoreMoMoSrories.LogWarning("Trying to cast an empty item");
//            }
//
