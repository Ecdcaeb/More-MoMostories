...
public class MoMoCards {
    ...
    public static class CardType{
        private static List<CardType> types=new ArrayList<>();
        public static final CardType INTERFERENCE=CardType.of();
        public static final CardType MYSTERIOUS=CardType.of();
        public static final CardType NATURE=CardType.of();
        public static final CardType ITEMS=CardType.of();
        public static final CardType HILEB=CardType.of();
        private CardType(){
            types.add(this);
        }
        public static CardType of(){
            return new CardType();
        }
        public static List<CardType> values(){
            List<CardType> clones=new ArrayList<>();
