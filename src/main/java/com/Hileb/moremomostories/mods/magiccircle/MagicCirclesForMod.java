package com.Hileb.moremomostories.mods.magiccircle;

import com.Hileb.moremomostories.common.world.damageSource.ModDamageSources;
...
public class MagicCirclesForMod {
    ...
    public static final MagicCircleSixstars Magic_Circle_of_Xe =new MagicCircleSixstars(
            com.Hileb.moremomostories.common.world.item.ModItems.ITEM_XE
            , com.Hileb.moremomostories.common.world.item.ModItems.ITEM_XE, com.Hileb.moremomostories.common.world.item.ModItems.ITEM_XE
            , com.Hileb.moremomostories.common.world.item.ModItems.ITEM_XE, com.Hileb.moremomostories.common.world.item.ModItems.ITEM_XE
            , com.Hileb.moremomostories.common.world.item.ModItems.ITEM_XE){
        @Override
        public void doCircle(TileEntityLockableLoot block) {
