...
public class BladeTianKi implements IBlade {
        ...
        public void registerBlade() {
            ...
            ItemSlashBladeNamed.CurrentItemName.set(tag, "moremomostories.blandTianki");//设置客户端刀名
        ...
        public void registerRecipe() {
            ...
            //将该配方真正添加
            SlashBlade.addRecipe("moremomostories.blandTianki", new BasicBladeRecipe(new ResourceLocation("flammpfeil.slashblade", "testBlade1"), blade, reqiredBlade, new Object[]{"QGO", "GBG", "OGQ", 'G', "ingotGold", 'O', Blocks.IRON_BLOCK, 'Q', Blocks.IRON_BLOCK, 'B', reqiredBlade}));
        }
        @Override
