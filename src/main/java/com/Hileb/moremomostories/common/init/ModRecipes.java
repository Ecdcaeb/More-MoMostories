...
import com.Hileb.moremomostories.common.world.recipe.*;
...
//		//
		//使用腐烂配方当作两个物品的无序配方
		r.register(new RecipePutrid(ModItems.THE_BOOK_OF_MANIFESTATION, com.Hileb.moremomostories.common.world.item.ModItems.ITEM_PAPER_IDONOTWANTTODIE, com.Hileb.moremomostories.common.world.item.ModItems.ITEM_SCENE_1).setRegistryName(new ResourceLocation(Reference.MOD_ID, String.format("recipe_emp_scene1"))));
		...
		//核心配方
		r.register(new MainRecipes("moremomostories.main",new ItemStack(com.Hileb.moremomostories.common.world.item.ModItems.ITEM_MAIN_NULL)).setRegistryName(Reference.MOD_ID,"main_r"));
		//通行符节
