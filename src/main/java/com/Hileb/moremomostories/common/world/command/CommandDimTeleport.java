package com.Hileb.moremomostories.common.world.command;
...
public class CommandDimTeleport extends CommandBase {
    ...
    private final List<String> aliases = Lists.newArrayList(MoreMoMoSrories.MODID, "tp", "tpdim", "tpdimension", "chuansong");
