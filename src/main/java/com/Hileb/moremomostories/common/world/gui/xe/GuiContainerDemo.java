package com.Hileb.moremomostories.common.world.gui.xe;
...
import static com.Hileb.moremomostories.common.world.gui.ModGuiElementLoader.GUI_DEMO;

@SideOnly(Side.CLIENT)
public class GuiContainerDemo extends GuiContainer
{
    private static final String TEXTURE_PATH = MoreMoMoSrories.MODID + ":" + "textures/gui/bitdo/gui_demo.png";
