package com.Hileb.moremomostories.common.world.gui.paper.paper1;
...
import static com.Hileb.moremomostories.common.world.gui.ModGuiElementLoader.GUI_PAPER_1;

@SideOnly(Side.CLIENT)
public class GuiContainerPaper1 extends GuiContainer
{
    private static final String TEXTURE_PATH = MoreMoMoSrories.MODID + ":" + "textures/gui/paper/paper.png";
