...
public class EntityZFP extends EntityAnimal {
    ...
    public EntityZFP(World worldIn) {
        ...
        this.setHeldItem(EnumHand.MAIN_HAND,new ItemStack(com.Hileb.moremomostories.common.world.item.ModItems.ITEM_DAO));
        this.setItemStackToSlot(EntityEquipmentSlot.HEAD,new ItemStack(com.Hileb.moremomostories.common.world.item.ModItems.ITEM_ZFP_HEADSET));
    }
...
//        this.targetTasks.addTask(3, new EntityAINearestAttackableTarget(this, EntityIronGolem.class, true));
    ...
    public Item ElectricShakingItem(){
        return com.Hileb.moremomostories.common.world.item.ModItems.ITEM_DO_FOREVER;
    }
    @SubscribeEvent
    ...
    public void onPlayerLogin(PlayerEvent.PlayerLoggedInEvent event){
        ...
        if(!world.isRemote){
            if (this.getValueOfZFP()>=50){
                ModCommands.give(event.player,new ItemStack(com.Hileb.moremomostories.common.world.item.ModItems.ITEM_DUCK_COOKED));
            }
        }
    }
